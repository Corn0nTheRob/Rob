...
function Blob() {
   ...
   useEffect(()=>{
    ...
    //path element and property element
    ...
    document.getElementById('title').style.fill = `hsl(${hue + 60}, 75%, 5%)`;
  ...
  return (
    <div className="App"> 
      <div className="blobContainer">
        <svg className="svgBlob" viewBox="0 0 200 200">
          <defs>
            <linearGradient id="gradient" gradientTransform="rotate(90)">
              <stop id="blobStop1" offset="0%" stopColor="var(--startColor)" />
